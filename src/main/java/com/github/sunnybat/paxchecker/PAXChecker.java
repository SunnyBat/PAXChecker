...
public final class PAXChecker {
	...
	public static final String VERSION = "4.0.0 R3";
	...
	/**
	 * Checks for tickets. Blocks indefinitely. Note that if checker is not checking anything, this
	 * method does not block and only modifies the StatusGUI GUI status text.
	 *
