...
public class Browser {
	...
	/**
	 * Opens the link given in the computer's default browser. Note that this will NOT work if the
	 * desktop environment isn't supported (generally a non-issue).
	 *
	...
	/**
	 * Opens the URL given in the computer's default browser. Note that this will NOT work if the
	 * desktop environment isn't supported (generally a non-issue). Also note that this will simply
	 * open the URL -- it will not parse through it to make sure it is valid!
	 *
	...
	/**
	 * Sets up a new HttpURLConnection with PAXChecker defaults. Connection has a 5-second connection
	 * timeout, 6-second read timeout.
	 *
