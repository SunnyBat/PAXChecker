...
public final class TicketChecker {
	...
	/**
	 * Checks whether or not the registered Checkers have an update. This method may block for several
	 * seconds.
	 *
	...
	/**
	 * Gets the last link found, or a zero-length String if a link has not been found or has been
	 * reset.
	 *
